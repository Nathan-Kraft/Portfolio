 ...
 * Machine.
 */
public class SodaVendingMachine<E> implements IVendingMachine {
    ...
    HashMap<String, Queue<IVendable>> vendingMachine = new HashMap<>();
...
//Currency Formatter specific to locale
     ...
     * @param counts
     */
    public SodaVendingMachine(E[] items, int[] counts) {
    ...
    public String GetMachineInfo() {
        String y = ("This is a Soda Vending machine." + "\n" + "You are able to choose which Soda you would like to purchase and then have the machine vend the item.");
        return y;
    ...
    public String DisplayContents() {
        String x = ("You have chosen a Soda machine. Here are your options\n");
