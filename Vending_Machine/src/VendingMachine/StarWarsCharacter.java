 ...
 * @author mhc31
 */
public class StarWarsCharacter implements Cloneable, IVendable {
    //------------------------------------------------------------
    //Properties 
    //--------------------------------------------------------------  
    ...
    public void setTauntPhrase(String tauntPhraseParam) {
        this.tauntPhrase = tauntPhraseParam;
    }
    ...
    public void setForce(Force forceparam) {
     ...
     * 
     */
    public StarWarsCharacter( String firstName, String lastName, double price) {
         setFirstName(firstName);
        setLastName(lastName);
        setPrice(price);
    }
    ...
    /**
     * the fight method decides the victor of each fight, based on their
     * ForceStrength. it has cases for if they are opposite forceType, they
     * would fight, and if they had equal forceStrenghth, as well as when they
     * are of the same ForceType.
     *
     * @param character1
     * @param character2
     */
